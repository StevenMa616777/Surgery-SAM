...
if __name__ == "__main__":
    sam = sam_model_registry["vit_h"](checkpoint="/hy-tmp/I157378211f00901317/SurgicalSAM/ckp/sam/sam_vit_h_4b8939.pth")
    lora_sam = LoRA_Sam(sam, 4).cuda()
    #lora_sam.sam.image_encoder(torch.rand(size=(1, 3, 1024, 1024)))
    img = torch.rand(size=(1,3,1024,1024)).cuda()
    preds = lora_sam(img, 1, 1024)
    print(preds.shape)